  ...
  return (
    <div className="bg-brand-1 min-h-screen text-brand-5 font-geist">
      ...
      <div className="flex flex-col lg:flex-row min-h-auto lg:min-h-screen relative">
        ...
        <div className="w-full lg:w-[45%] px-4 xs:px-6 sm:px-10 lg:px-12 pt-28 xs:pt-32 sm:pt-36 lg:pt-32 pb-8 lg:pb-24 flex flex-col justify-center">
          ...
          <motion.h1
            ...
            className="text-[2.6rem] xs:text-[3.2rem] sm:text-5xl md:text-6xl lg:text-7xl xl:text-[5rem] font-bebas leading-[0.92] tracking-tight mb-4 sm:mb-6 text-[#364B5D] relative z-10"
          >
            TU{' '}
            <span className="text-[#0C3B45]">
          ...
          <motion.div
            ...
            className="flex flex-col xs:flex-row items-stretch xs:items-center gap-2 sm:gap-3.5 mb-6 sm:mb-8"
          >
            <Link
              to="/cargarproductos"
          ...
          >
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-[#546A7E] font-semibold leading-tight mt-0.5">Óxido de Etileno</span>
            </div>
            <div className="flex flex-col border-x border-[#E1D9CC] px-2 text-center">
              ...
              <span className="text-[10px] text-[#546A7E] font-semibold leading-tight mt-0.5">Aprobación Oficial</span>
            </div>
            <div className="flex flex-col text-right">
              <span className="font-bebas text-base sm:text-xl text-[#0C3B45] leading-none">8 INSUMOS</span>
              <span className="text-[10px] text-[#546A7E] font-semibold leading-tight mt-0.5">Kit Único $9.500</span>
            </div>
          </motion.div>
        ...
        <div className="w-full lg:w-[55%] p-4 xs:p-5 sm:p-6 lg:p-8 lg:pl-0 lg:pt-8 flex items-center justify-center relative">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="w-full flex flex-col shadow-2xl rounded-3xl sm:rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden border border-black/5 group bg-white"
          >
            {/* Image Box */}
            <div className="w-full aspect-video sm:aspect-16/10 lg:aspect-auto lg:h-[60vh] lg:max-h-115 relative overflow-hidden">
              <img
            ...
            <div className="w-full p-4 sm:p-5 flex items-center justify-between gap-3 border-t border-[#E1D9CC]/50">
              <div className="min-w-0">
                <p className="font-bebas text-sm sm:text-lg text-[#364B5D] leading-tight truncate">
                  8 INSUMOS QUIRÚRGICOS DESCARTABLES
                </p>
                <p className="text-[10px] sm:text-xs text-[#546A7E] truncate mt-0.5">
                  Batas con puños • Compresas 1x1m y 50x50 • Campo fenestrado • Cubre suctores y más
                </p>
              </div>
              <Link
                to="/cargarproductos"
                className="shrink-0 px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl bg-[#88C9C4] hover:bg-[#6EB8B2] text-[#0C3B45] font-bebas text-sm sm:text-base tracking-wider transition-colors shadow-xs flex items-center gap-1 cursor-pointer"
              >
                <span>PEDIR</span>
                <ArrowRight size={14} />
              </Link>
        ...
        testimonials={[
          {
            author: {
              ...
              avatar: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?ixlib=rb-4.0.3&auto=format&fit=crop&w=64&q=80"
            },
          ...
          },
          {
            author: {
              ...
              avatar: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?ixlib=rb-4.0.3&auto=format&fit=crop&w=64&q=80"
            },
          ...
          },
          {
            author: {
              ...
              avatar: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?ixlib=rb-4.0.3&auto=format&fit=crop&w=64&q=80"
            },
          ...
          },
          {
            author: {
              ...
              avatar: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=64&q=80"
            },
          ...
          },
          {
            author: {
              ...
              avatar: "https://images.unsplash.com/photo-1594824432240-84c6c2162ebc?ixlib=rb-4.0.3&auto=format&fit=crop&w=64&q=80"
            },
          ...
          },
          {
            author: {
              ...
              avatar: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=64&q=80"
            },
          ...
          },
          {
            author: {
              ...
              avatar: "https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-4.0.3&auto=format&fit=crop&w=64&q=80"
            },
