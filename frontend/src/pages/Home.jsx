  ...
  return (
    <div className="bg-brand-1 min-h-screen text-brand-5 font-geist">
      ...
      <div className="w-full lg:w-[55%] p-4 xs:p-5 sm:p-6 lg:p-8 lg:pl-0 lg:pt-24 flex items-center justify-center relative">
        ...
        >
          {/* Image Box */}
          <div className="w-full aspect-video sm:aspect-[16/10] lg:aspect-auto lg:h-[60vh] lg:max-h-[460px] relative overflow-hidden">
            <img
          ...
          <div className="w-full p-4 sm:p-5 flex items-center justify-between gap-3 border-t border-[#E1D9CC]/50">
            <div className="min-w-0">
              ...
              <p className="text-[10px] sm:text-xs text-[#8CA0B2] truncate mt-0.5">
