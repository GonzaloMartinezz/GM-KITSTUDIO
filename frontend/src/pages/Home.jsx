...
import { ShoppingCart, ShieldCheck, Truck, Clock, ArrowRight, ArrowLeft, MessageCircle, Mail, FileText, Ruler, Activity, BookOpen, HeartHandshake } from 'lucide-react';
    ...
    <div className="bg-brand-1 min-h-screen text-brand-5 overflow-x-hidden font-geist">
      ...
      <div className="flex flex-col lg:flex-row min-h-screen relative overflow-hidden">
        ...
        <div className="w-full lg:w-[45%] px-6 md:px-12 pt-40 pb-32 flex flex-col justify-center">
          ...
          >
            <div className="border border-brand-5/20 rounded-full px-6 py-2 flex items-center gap-2 text-brand-5/60">
              <span className="text-sm">Scroll</span>
            </div>
            <div className="h-px bg-brand-5/20 flex-grow border-dashed border-t"></div>
          </motion.div>
      ...
      <section className="bg-brand-5 text-brand-1 rounded-t-[60px] -mt-10 relative z-40 py-24 px-6 md:px-12 lg:px-24 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-12">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="font-bebas text-center mb-8 md:mb-16 text-[clamp(4rem,12vw,120px)] uppercase leading-none tracking-wider text-brand-1"
          >
            SERVICES
          </motion.h2>
          ...
          {servicesList.map((service, index) => (
            <motion.div 
              ...
              className="flex flex-col items-center text-center gap-2 border-b border-brand-1/20 pb-8 pt-4 group hover:border-brand-1 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6">
            ...
            {bentoCards.map((card, index) => (
              <motion.div 
                ...
                className="relative overflow-hidden group bg-[#3E5C76] rounded-[2rem] md:rounded-[3rem] p-8 md:p-10 h-[250px] md:h-[300px] flex flex-col justify-center items-center shadow-xl cursor-pointer"
              >
                {/* Wave effect */}
                <div className="absolute top-[120%] left-1/2 -translate-x-1/2 w-[250%] aspect-square bg-[#88C9C4] rounded-[45%] group-hover:top-[-50%] group-hover:rotate-[170deg] transition-all duration-[1200ms] ease-in-out z-0 pointer-events-none"></div>
                
                {/* Content */}
                <div className="relative z-10 pointer-events-none w-full flex flex-col items-center text-center gap-4">
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-[#88C9C4] text-[#0C3B45] group-hover:bg-[#0C3B45] group-hover:text-[#88C9C4] flex items-center justify-center transition-colors duration-[800ms] shadow-sm">
                    <card.icon size={28} />
                  </div>
                  <h3 className="font-bebas text-[clamp(1.5rem,2vw,2rem)] leading-none text-[#88C9C4] group-hover:text-[#0C3B45] transition-colors duration-[800ms]">
                    {card.title}
                  </h3>
                  <p className="font-geist text-[#F1E8D9] group-hover:text-[#0C3B45] transition-colors duration-[800ms] text-sm md:text-base font-light px-2">
                    {card.desc}
                  </p>
                </div>
              </motion.div>
            ...
            <motion.div 
              ...
              className="md:col-span-2 relative overflow-hidden group bg-[#88C9C4] rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 min-h-[350px] flex flex-col justify-center shadow-xl cursor-pointer"
            >
              {/* Wave effect for wide card */}
              <div className="absolute top-[120%] left-1/2 -translate-x-1/2 w-[200%] md:w-[150%] aspect-square bg-[#0C3B45] rounded-[40%] group-hover:top-[-120%] md:group-hover:top-[-100%] group-hover:rotate-[150deg] transition-all duration-[1500ms] ease-in-out z-0 pointer-events-none"></div>
      ...
      <section className="bg-brand-1 py-24 md:py-32 flex flex-col justify-center items-center overflow-hidden relative z-40">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] md:w-[800px] h-[600px] md:h-[800px] bg-brand-2/20 rounded-full blur-[100px] md:blur-[120px] z-0 pointer-events-none mix-blend-overlay"></div>
        
        {/* Dynamic Glow Trail */}
        <motion.div 
           animate={{ opacity: [0.4, 0.7, 0.4], scale: [1, 1.05, 1] }} 
           transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
           className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120vw] h-[200px] md:h-[300px] bg-gradient-to-r from-transparent via-brand-3/30 to-transparent blur-[60px] md:blur-[80px] z-0"
        ></motion.div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100vw] h-[100px] md:h-[150px] bg-gradient-to-r from-transparent via-brand-4/40 to-transparent blur-[40px] md:blur-[50px] z-0 transform -rotate-2"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100vw] h-[100px] md:h-[150px] bg-gradient-to-r from-transparent via-[#88C9C4]/20 to-transparent blur-[50px] md:blur-[60px] z-0 transform rotate-2"></div>
      ...
      <section className="bg-gradient-to-br from-[#3E5C76] via-brand-5 to-[#061F24] pt-32 pb-0 overflow-hidden relative z-50 rounded-t-[60px] -mt-10 shadow-[0_-20px_50px_rgba(0,0,0,0.2)]">
        ...
        {/* Arches Container */}
        <div className="max-w-[1400px] mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 relative z-10 items-end">
          
          {/* Column 1 */}
          <div className="bg-brand-1 rounded-[40px] md:rounded-b-none md:rounded-t-[60px] pb-[440px] md:pb-0 md:h-[600px] flex flex-col items-center pt-16 px-6 md:px-10 relative w-full shadow-[0_-10px_40px_rgba(0,0,0,0.1)] group overflow-hidden md:overflow-visible">
            ...
            {/* Phone Mockup */}
            <div className="w-[280px] h-[560px] bg-white border-[8px] border-[#111] rounded-[3rem] shadow-2xl absolute bottom-[-40px] md:bottom-[-120px] flex flex-col overflow-hidden relative group-hover:-translate-y-4 transition-transform duration-700">
              ...
              <div className="flex-1 bg-brand-5 p-6 pt-20 flex flex-col items-center relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-[#000] z-0 opacity-20"></div>
          ...
          {/* Column 2 */}
          <div className="bg-brand-1 rounded-[40px] md:rounded-b-none md:rounded-t-[60px] pt-[480px] md:pt-0 md:h-[700px] flex flex-col items-center px-6 md:px-10 relative w-full z-20 shadow-[0_-10px_40px_rgba(0,0,0,0.15)] group overflow-hidden md:overflow-visible">
            {/* Phone Mockup */}
            <div className="w-[280px] h-[560px] bg-white border-[8px] border-[#111] rounded-[3rem] shadow-[0_30px_60px_rgba(0,0,0,0.3)] absolute top-[-40px] md:top-[-80px] flex flex-col overflow-hidden relative group-hover:-translate-y-4 transition-transform duration-700">
              <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-24 h-7 bg-[#111] rounded-full z-20"></div>
              
              <div className="flex-1 bg-brand-1/40 p-6 pt-20 flex flex-col items-center relative">
                {/* Decorative blob */}
                <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-brand-3/20 to-transparent z-0"></div>
                ...
                <div className="w-full relative z-10">
                   ...
                   <button className="mt-12 bg-transparent border border-brand-5 text-brand-5 px-12 py-4 rounded-full font-bebas tracking-widest text-xl hover:bg-brand-5 hover:text-brand-1 transition-all duration-300 shadow-[0_0_20px_rgba(62,92,118,0.1)] hover:shadow-[0_0_30px_rgba(62,92,118,0.3)] relative overflow-hidden group">
                     ...
                     <div className="absolute inset-0 bg-brand-5 translate-y-[100%] group-hover:translate-y-0 transition-transform duration-300 ease-out z-0"></div>
                   </button>
                </div>
              </div>
            </div>
          ...
          <div className="bg-brand-1 rounded-[40px] md:rounded-b-none md:rounded-t-[60px] pb-[440px] md:pb-0 md:h-[600px] flex flex-col items-center pt-16 px-6 md:px-10 relative w-full shadow-[0_-10px_40px_rgba(0,0,0,0.1)] group overflow-hidden md:overflow-visible">
            ...
            <div className="w-[280px] h-[560px] bg-white border-[8px] border-[#111] rounded-[3rem] shadow-2xl absolute bottom-[-40px] md:bottom-[-120px] flex flex-col overflow-hidden relative group-hover:-translate-y-4 transition-transform duration-700">
              ...
              <div className="flex-1 bg-[#F8F9FA] p-6 pt-20 flex flex-col">
                ...
                <div className="w-full h-40 bg-gradient-to-br from-brand-5 via-[#20666B] to-[#3E5C76] rounded-3xl mb-6 p-5 flex flex-col justify-between shadow-xl relative overflow-hidden">
        ...
        <div className="h-[250px] bg-brand-1 absolute bottom-0 left-0 w-full z-0 border-t border-brand-1"></div>
      </section>
