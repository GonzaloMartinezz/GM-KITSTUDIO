...
const ReviewsSection = () => {
  ...
  return (
    <div className="max-w-350 mx-auto px-4 md:px-8 py-20 font-geist relative z-30 flex flex-col gap-6 md:gap-10">
      ...
      <div className="bg-white rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-16 shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-brand-5/5">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          {/* Left: Big Rating Box */}
          <div className="w-full lg:w-1/3 flex flex-col items-center justify-center bg-[#F8F9FA] rounded-4xl p-10 border border-brand-5/5">
